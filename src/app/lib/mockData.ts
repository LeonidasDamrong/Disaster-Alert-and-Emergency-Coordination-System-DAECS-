...
export const mockAlerts: Alert[] = [
  ...
  },
  {
    ...
    message: 'Additional shelter facilities now open at Dewan Komuniti Taman Melati. TotalCapacity for 200 evacuees.',
    type: 'Information',
...
export const mockResources: Resource[] = [
  {
    resourceItemId: 'RES001',
    warehouseId: 'WH001',
    warehouseName: 'Central Warehouse KL',
    name: 'Rice (bags)',
    type: 'Food',
    quantity: 500,
    unit: 'kg',
  ...
  {
    resourceItemId: 'RES004',
    warehouseId: 'WH002',
    warehouseName: 'Equipment Depot Selangor',
...
export const mockResourceRequests: ResourceRequest[] = [
  ...
  },
  {
    ...
    urgency: 'Low',
    status: 'Rejected',
    rejectionReason: 'Insufficient stock. Alternative items will be provided.',
